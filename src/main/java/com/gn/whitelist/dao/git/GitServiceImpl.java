...
@ApplicationScoped
public class GitServiceImpl implements WhitelistingStorageService {
    ...
    public void addNewOperator(Operator operator) {
        ...
        gitClient.commitChanges("Adding operator " + operator.getCode(), "Backendapp", "backend@expenti.com");
        gitClient.pushChanges();
    }
